"""Prove the correction stays in presentation-only functions and stable data."""
import hashlib,json,re,subprocess
from pathlib import Path
ROOT=Path(__file__).resolve().parents[3]
BASE='a80b2820ea932166ab0ce526f835f830f9825772'
...
assert set(changed)=={'_character_body_metric','_load_character_animation_frames'},changed
