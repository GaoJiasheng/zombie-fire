...
func _skill_short_desc(skill_id: String, lv: int) -> String:
	return preload("res://ui/skill_description.gd").short_description(skill_id, lv)
...
func _skill_long_desc(skill_id: String, lv: int) -> String:
	match skill_id:
		...
		"skill_critical":
			return "提高暴击概率、全局伤害，3级起提高暴击伤害；适合高射速武器和首领战。"
		"skill_barrier":
			return "提高基地生命上限。等级成长为+20%/+40%/+60%/+80%/+120%，并立即补上新增生命。"
		"skill_gold_rush":
		...
		"skill_charge_shot":
			return "提供直接伤害加成，并让主弹对护甲/护盾单位造成一部分本体穿透伤害，适合处理厚甲首领。"
		"skill_recycle":
