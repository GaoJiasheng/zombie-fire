...
SFX = [
	...
	"sfx_enemy_attack_claw", "sfx_enemy_attack_fast_claw", "sfx_enemy_attack_bite",
	"sfx_enemy_attack_heavy_slam", "sfx_enemy_attack_blast", "sfx_enemy_attack_corrosion",
	"sfx_enemy_attack_support",
