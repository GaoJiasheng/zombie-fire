...
NON_VISUAL_CHECKS = [
    ...
    Check(("python3", "tools/audit_free_elemental_weapons.py", "--check")),
    ...
    Check(("python3", "tools/check_upgrade_resource_icons.py")),
	...
	Check(("python3", "tools/check_combat_foley_sfx_quality.py")),
